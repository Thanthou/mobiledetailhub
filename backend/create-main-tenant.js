...
async function createMainTenant() {
  try {
    ...
    const existingTenant = await pool.query(
      'SELECT id, slug, business_name FROM tenants.tenants WHERE slug = $1',
    ...
    const result = await pool.query(`
      ...
      RETURNING id, slug, business_name, email, phone
    `, [
      'thatsmartsite-backend',           // slug
      'That Smart Site',                 // business_name
      'Website Generator',               // business_type
      'admin@thatsmartsite.com',         // email
      '(555) 123-4580',                  // phone
      '123 Main St',                     // address
      'Your City',                       // city
      'Your State',                      // state
