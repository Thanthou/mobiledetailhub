-- Migration: Recreate reviews table with simplified schema
-- This matches the tenant dashboard AddReviewForm exactly

-- Drop existing reviews table and all dependent objects
...
-- Add foreign key constraint (adjust based on your tenants table structure)
