...
const AUDITS = [
  ...
  { name: 'Backend Flow Tracer', script: 'audit-flows.js', critical: false },
  { name: 'Frontend Flow: main-site', script: 'audit-flows-frontend.js main-site', critical: false },
  { name: 'Frontend Flow: tenant-app', script: 'audit-flows-frontend.js tenant-app', critical: false },
  { name: 'Frontend Flow: admin-app', script: 'audit-flows-frontend.js admin-app', critical: false },
