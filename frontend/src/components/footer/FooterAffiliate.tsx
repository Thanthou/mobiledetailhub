...
const FooterAffiliate: React.FC<FooterProps> = ({ onRequestQuote }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-12">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <a href="/contact" className="text-lg hover:text-orange-400 transition-colors duration-200 inline-block">
                Contact
              </a>
            </div>
          </div>
