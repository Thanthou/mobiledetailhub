...
function getGeoParts(cfg: { business?: { city?: string; locality?: string; state?: string; region?: string } }) {
...
export const AFFILIATE_FAQ_PRICING = (cfg: { business?: { city?: string; locality?: string; state?: string; region?: string } }): FAQItem[] => {
