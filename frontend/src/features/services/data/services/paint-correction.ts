...
export const paintCorrectionData: ServiceData = {
  ...
  shortDescription: 'Professional paint correction to restore true gloss and clarity',
  heroImage,

  overview: {
    title: 'Paint Correction Overview',
    content: 'Professional machine polishing that removes swirls, haze, and light scratches to restore true gloss and clarity.',
    benefits: [
      'Removes wash swirls and light scratches',
      'Restores depth and clarity',
      'Eliminates holograms from poor polishing',
      'Prepares paint for protection coatings'
    ],
    features: [
    ...
    images: [
      {
        ...
        caption: 'Professional paint correction process'
      }
    ]
  },
    ...
    questions: [
      {
        ...
        answer: 'It removes the vast majority of swirls, haze, and light defects. Deep scratches may require touch-up or bodywork.'
      },
      {
        id: 2,
        question: 'Is it safe for my clear coat?',
        answer: 'Yes. We use a measured approach with modern dual-action polishers and controlled heat to safely level defects.'
      }
    ]
  },
    ...
    tiers: [
      {
        ...
        price: '$400',
        description: 'Light defect removal and gloss enhancement',
        popular: false,
        features: ['Light polishing', 'Gloss enhancement', 'Basic protection']
      },
      {
        id: 'two-step',
        name: 'Two-Step Correction',
        price: '$800',
        description: 'Comprehensive defect removal and refinement',
        popular: true,
        features: ['Cutting and refining', 'Defect removal', 'Premium protection']
      }
    ]
  },
