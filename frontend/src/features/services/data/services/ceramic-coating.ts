...
export const ceramicCoatingData: ServiceData = {
  ...
  shortDescription: 'Professional ceramic coating for long-lasting protection and gloss',
  heroImage,

  overview: {
    title: 'Ceramic Coating Overview',
    content: 'Professional nano-ceramic coating application for maximum protection and gloss.',
    benefits: [
      'Long-lasting protection (3-8 years)',
      'Deep gloss and hydrophobic properties',
      'Chemical and UV resistance',
      'Easier maintenance and washing'
    ],
    features: [
      'Paint correction and prep',
    ...
    questions: [
      {
        ...
        answer: 'Professional coatings are designed to last multiple years with proper care. Lifespan depends on environment and wash routine.'
      },
      {
        id: 2,
        question: 'Is paint correction required?',
        answer: 'Highly recommended. Coatings lock in the paint\'s current state. We refine swirls/haze first so you seal in maximum clarity.'
      }
    ]
  },
    ...
    tiers: [
      {
        ...
        price: '$800',
        description: 'Standard ceramic coating application',
        popular: false,
        features: ['Paint prep', 'Basic coating', '1-year warranty']
      },
      {
        id: 'premium',
        name: 'Premium Ceramic Coating',
        price: '$1500',
        description: 'High-grade ceramic coating with paint correction',
        popular: true,
        features: ['Paint correction', 'Premium coating', '3-year warranty']
      }
    ]
  },
