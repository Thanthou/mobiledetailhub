...
export const autoDetailingData: ServiceData = {
  ...
  overview: {
    title: 'Auto Detailing Overview',
    content: 'Professional mobile auto detailing service that brings the detail shop to your location.',
    benefits: [
    ...
    questions: [
      {
        ...
        answer: 'Typically 5-8 hours for standard vehicles and details.'
      },
      {
        id: 2,
        question: 'Do you bring water and power?',
        answer: 'Yes. We are fully mobile and bring filtered water, power, and all professional equipment.'
      }
    ]
  },

  pricing: {
    title: 'Auto Detailing Pricing',
    tiers: [
      {
        id: 'basic',
        name: 'Basic Detail',
        price: '$150',
        description: 'Standard interior and exterior cleaning',
        popular: false,
        features: ['Exterior wash', 'Interior vacuum', 'Basic protection']
      },
      {
        id: 'premium',
        name: 'Premium Detail',
        price: '$250',
        description: 'Complete detailing with decontamination',
        popular: true,
        features: ['Full decontamination', 'Clay treatment', 'Protective sealant']
      }
    ]
  },
