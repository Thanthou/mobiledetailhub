...
import { useScheduleOptions } from '@main/components/booking/hooks';
import type { ScheduleOption } from '@main/components/booking/hooks/useScheduleOptions';
import { useBookingSchedule } from '@main/components/booking/state';
