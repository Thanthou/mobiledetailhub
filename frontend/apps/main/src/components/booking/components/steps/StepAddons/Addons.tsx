...
import type { AddonItem } from '@main/components/booking/hooks';
import { useAddons } from '@main/components/booking/hooks';
import { useBookingAddons, useBookingVehicle } from '@main/components/booking/state';
