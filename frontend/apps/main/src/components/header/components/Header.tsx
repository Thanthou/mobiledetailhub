...
import { NAV_LINKS } from '@main/components/header/utils/constants';
import { handleSectionClick } from '@main/components/header/utils/navigation';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-4 md:px-6 min-w-0">
          ...
          <div className="flex md:hidden items-center justify-between gap-3 min-w-0">
            ...
            <button
              ...
              onClick={() => { setOpen(v => !v); }}
              className="flex-shrink-0 inline-flex items-center justify-center p-2 rounded-md text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-cyan-400"
            >
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6 min-w-0">
            <Logo />
            <h1 className="text-xl lg:text-2xl xl:text-3xl font-bold text-white leading-tight truncate">
              {businessName}
            </h1>
            ...
            {(() => {
              ...
              return link.isFAQ ? (
                <button
                  ...
                  className="nav-link w-full text-left px-4 py-3 rounded-lg text-base sm:text-lg text-white bg-transparent hover:text-cyan-400 hover:bg-cyan-500/10 focus:text-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-black/20 transition-colors duration-200"
                ...
                <a
                  ...
                  href={link.href}
                  onClick={handleClick}
                  className="nav-link block w-full text-left px-4 py-3 rounded-lg text-base sm:text-lg text-white bg-transparent hover:text-cyan-400 hover:bg-cyan-500/10 focus:text-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-black/20 transition-colors duration-200"
